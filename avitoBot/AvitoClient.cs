...
namespace avitoBot
{
	public class AvitoClient
	{
		...
		public async Task<string> getHtmlofItems()
		{
            ...
            var request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri("https://www.avito.ru/sankt_peterburg_i_lo/mebel_i_interer?f=ASgBAgICAUSKvQ280jQ&geoCoords=59.939095%2C30.315868&presentationType=serp&s=104&p=2"),
                Headers =
                        {
