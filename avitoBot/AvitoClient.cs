...
namespace avitoBot
{
	public class AvitoClient
	{
        ...
        {
            ///https://www.avito.ru/sankt_peterburg_i_lo/mebel_i_interer?f=ASgBAgICAUSKvQ280jQ&geoCoords=59.939095%2C30.315868&presentationType=serp&s=104&p={page} было
            ...
            if(page == 1) 
                sUrl = sUrl.Contains("?") ? sUrl + $"&p={page}" : sUrl + $"?p={page}";
